        ...
        try:
            ...
            if la_ == 1:
                ...
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & (
                        (1 << CPP14Parser.TrueFalse) | (1 << CPP14Parser.Nullptr) | (1 << CPP14Parser.This))) != 0) or (
                        (((_la - 104)) & ~0x3f) == 0 and ((1 << (_la - 104)) & (
                                (1 << (CPP14Parser.Numberliteral - 104)) | (
                                1 << (CPP14Parser.Characterliteral - 104)) | (
                            1 << (CPP14Parser.Stringliteral - 104)) | (1 << (CPP14Parser.Userdefinedliteral - 104)) | (
        ...
        try:
            ...
            if la_ == 1:
                ...
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & (
                        ...
                        1 << CPP14Parser.Minus) | (1 << CPP14Parser.Star))) != 0) or ((((_la - 64)) & ~0x3f) == 0 and (
